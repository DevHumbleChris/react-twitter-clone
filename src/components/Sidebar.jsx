    ...
    <aside className="sticky top-0 h-screen w-18 sm:w-[21rem] border border-gray-200">
      ...
      <nav className="space-y-4 text-lg">
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          ...
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">Home</h1>
        </div>
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          <HashtagIcon className="w-12 h-12 text-[#1ca0f2]" />
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">Explore</h1>
        </div>
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          <BellIcon className="w-12 h-12 text-[#1ca0f2]" />
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">
            Notifications
          </h1>
        </div>
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          <EnvelopeIcon className="w-12 h-12 text-[#1ca0f2]" />
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">Messages</h1>
        </div>
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
        ...
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          ...
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">Profile</h1>
        </div>
        <div className="flex items-center px-4 space-x-2 cursor-pointer">
          <EllipsisHorizontalCircleIcon className="w-12 h-12 text-[#1ca0f2]" />
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">More</h1>
        </div>
        <div
          onClick={appSignOut}
        ...
        >
          ...
          <h1 className="hidden sm:block hover:text-[#1ca0f2]">Logout</h1>
        </div>
      </nav>
    </aside>
  );
